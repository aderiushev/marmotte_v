...
public class ModerationPage extends UserInterface implements ActionListener, ListSelectionListener {
    ...
    public ModerationPage() {
        ...
        List sets = this.getBi().getProject().getSets();

        int sListSize = sets.size();
        Object[][] tblData = new Object[sListSize][sListSize];
    ...
    public void valueChanged(ListSelectionEvent e) {  
       ...
       this.setSelectedSet(Integer.parseInt(this.jtable.getValueAt(this.getSelectedRow(), this.SET_ID_COLUMN).toString()));
    } 
